...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    // Init
    SData/*8:0*/ __Vdly__sigdelay__DOT__address1;
    ...
    if (vlSelf->rd) {
        vlSelf->delayed_signal = vlSelf->sigdelay__DOT__micRam__DOT__ram_array
    ...
    if (vlSelf->rst) {
        __Vdly__sigdelay__DOT__address1 = 0U;
        vlSelf->sigdelay__DOT__address2 = 0U;
    } else {
        __Vdly__sigdelay__DOT__address1 = (0x1ffU & 
                                           ((IData)(1U) 
                                            + (IData)(vlSelf->sigdelay__DOT__address1)));
        vlSelf->sigdelay__DOT__address2 = (0x1ffU & 
                                           (((IData)(1U) 
                                             + (IData)(vlSelf->sigdelay__DOT__address1)) 
                                            - (IData)(vlSelf->offset)));
    }
